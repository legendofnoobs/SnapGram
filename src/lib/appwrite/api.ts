...
// 		return session;
// 	} catch (error) {
// 		// Providing a more descriptive error log
// 		console.error('Failed to create a session. Please check your credentials.', error);
// 		throw error;
// 	}
// }
...
export async function updateUser(user: IUpdateUser) {
	...
	try {
		...
		console.log("looooooooooooooooooool", image.imageUrl)
